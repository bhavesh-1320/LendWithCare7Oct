...
export default class carouselcmp_Homepage extends LightningElement {
   ...
   /* @wire(getLoansByStage, { stage: '$stage', contactId: '$contactid' })
    ...
    handleViewTransactionsClick() {
        ...
        const urlWithParameters = baseUrl + 'caredasboardtransactions?Id=' + btoa(this.contactid);
    ...
    if(progressBarElements){
        ...
        const progressValue = (progressBar.dataset.value >=100)?98.75:progressBar.dataset.value;//progressBar.dataset.value - 2:progressBar.dataset.value;
